...
namespace Exchange {
    ...
    enum IDS : uint32_t {
        ...
        ID_WIFICONTROL_NETWORK_INFO                  = ID_WIFICONTROL + 2,
        ID_WIFICONTROL_NETWORK_INFO_ITERATOR         = ID_WIFICONTROL + 3,
        ID_WIFICONTROL_CONFIG_INFO_ITERATOR          = ID_WIFICONTROL + 4,
        ID_WIFICONTROL_PAIR_ITERATOR                 = ID_WIFICONTROL + 5,

        ID_NETWORKCONTROL                            = 0x000004D0,
        ID_NETWORKCONTROL_NOTIFICATION               = ID_WIFICONTROL + 1,
        ID_NETWORKCONTROL_NETWORK_INFO_ITERATOR      = ID_WIFICONTROL + 2
    };
}
}
